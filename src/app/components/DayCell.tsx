...
export default function DayCell({ day, isToday }: Props) {
    ...
    return (
        <div
            className={`flex p-2 rounded-md hover:border hover:border-black min-h-[13vh] cursor-pointer transform transition-transform ease-in-out duration-100 hover:scale-125 z-0 hover:z-10 ${
        ...
        >
            ...
            <div className="flex-1 ml-1 pl-2">BEISPIEL XDD</div>
        </div>
    );
}
